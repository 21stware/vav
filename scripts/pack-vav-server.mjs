...
pkg.files = (pkg.files || []).filter((file) => file !== 'vav-board.js' && file !== 'vav-tui.js')
...
const phoneUi = join(root, 'out', 'phone-ui')
...
console.log(`[pack-vav-server] ${pkg.name}@${pkg.version} → ${outfile}`)
