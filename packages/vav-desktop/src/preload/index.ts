...
const api: VavApi = {
  ...
  connectors: {
    ...
    authStatus: () => ipcRenderer.invoke(IPC.connectorsAuthStatus),
    beginLogin: (id) => ipcRenderer.invoke(IPC.connectorsBeginLogin, id),
    cancelLogin: (id) => ipcRenderer.invoke(IPC.connectorsCancelLogin, id)
  },
  ...
  timers: {
    ...
    createScheduled: () => ipcRenderer.invoke(IPC.timersCreateScheduled),
    getJobForConversation: (conversationId) =>
      ipcRenderer.invoke(IPC.timersGetJobForConversation, conversationId),
