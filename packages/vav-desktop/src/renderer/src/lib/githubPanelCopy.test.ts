...
describe('githubPanelCopy', () => {
  ...
  it('labels action and Pages statuses', () => {
    ...
    assert.equal(actionStatusLabel('completed', t, 'success'), 'github.actionCompleted')
    assert.equal(actionStatusLabel('completed', t, 'failure'), 'github.actionFailed')
    assert.equal(actionStatusLabel('completed', t, 'startup_failure'), 'github.actionFailed')
    assert.equal(actionStatusLabel('completed', t, 'cancelled'), 'github.actionCancelled')
    assert.equal(actionStatusLabel('completed', t, 'skipped'), 'github.actionSkipped')
    assert.equal(actionStatusLabel('completed', t, 'timed_out'), 'github.actionTimedOut')
    assert.equal(actionStatusLabel('completed', t, 'action_required'), 'github.actionRequired')
