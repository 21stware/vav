...
describe('githubPanelState', () => {
  it('maps pull and action statuses onto list row classes', () => {
    ...
    assert.equal(githubActionStateClass('completed', 'success'), 'is-merged')
    assert.equal(githubActionStateClass('completed', 'failure'), 'is-closed')
    assert.equal(githubActionStateClass('completed', 'startup_failure'), 'is-closed')
    assert.equal(githubActionStateClass('completed', 'timed_out'), 'is-closed')
    assert.equal(githubActionStateClass('completed', 'cancelled'), 'is-draft')
    assert.equal(githubActionStateClass('completed', 'skipped'), 'is-draft')
    assert.equal(githubActionStateClass('completed', 'action_required'), 'is-open')
