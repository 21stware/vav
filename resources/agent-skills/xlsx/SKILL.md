---
name: minimax-xlsx
description: "Fallback Excel/OpenXML skill when officecli cannot complete the task. In VAV prefer load_skill(\"officecli\") for .xlsx create/edit; prefer sql_query for .csv/.tsv/.parquet/SQLite analysis. Use this skill for complex Excel authoring, formula validation, or when officecli is insufficient — not as the default path for every spreadsheet request."
license: MIT
metadata:
  version: "1.0"
