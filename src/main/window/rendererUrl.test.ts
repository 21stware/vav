...
describe('isRendererUrl', () => {
  it('accepts the Vite dev server and packaged file URLs', () => {
    ...
    assert.equal(isRendererUrl('file:///app/out/renderer/index.html', dev), true)
    assert.equal(isRendererUrl('file:///app/out/renderer/screenshot.html', undefined), true)
    assert.equal(isRendererUrl('file:///Users/x/Downloads/a.html', undefined), false)
    assert.equal(isRendererUrl('file:///app/index.html', undefined), false)
