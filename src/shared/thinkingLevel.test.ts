...
describe('sessionShowsThinking / sessionShowsFast', () => {
  it('shows thinking on VAV and Cursor, fast only on Cursor', () => {
    ...
    assert.equal(sessionShowsThinking('cursor', 'grok-4.6-low-fast'), false)
    assert.equal(sessionShowsThinking('cursor', 'cursor-grok-4.6-medium'), false)
    ...
    assert.equal(sessionShowsFast('cursor', 'grok-4.6'), true)
    assert.equal(sessionShowsFast('cursor', 'cursor-grok-4.6-medium'), false)
